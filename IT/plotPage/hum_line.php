<?php
 ...
 session_start();
	...
	$first = mysqli_query($polaczenie2,"SELECT humidity AS hum, DATE_FORMAT(dht11.date,'%T') AS date, DATE(dht11.date) AS date_day FROM dht11 WHERE DATE(dht11.date) = '$data_get'");
...
<form action="../plotPage/hum_line.php" method="get">
