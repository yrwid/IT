<?php
 ...
 session_start();
	...
	$first = mysqli_query($polaczenie2,"SELECT humidity_bmp AS press, DATE_FORMAT(bmp180.date,'%T') AS date, DATE(bmp180.date) AS date_day FROM bmp180 WHERE DATE(bmp180.date) = '$data_get'");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	zoomEnabled: true,
	title: {
		text: "DAILY ATMOSPHERIC PRESSURE"
	},
	axisY: {
...
<form action="../plotPage/pressure_line.php" method="get">
...
<button id="back_button" onclick="window.location.href = '../indexPage/index.php';"class="cancelbtn">Back to main page!</button>
<!--
