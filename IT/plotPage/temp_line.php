<?php
 ...
 session_start();
	...
	$first = mysqli_query($polaczenie2,"SELECT temperature_bmp AS temp, DATE_FORMAT(bmp180.date,'%T') AS date, DATE(bmp180.date) AS date_day FROM bmp180 WHERE DATE(bmp180.date) = '$data_get'");
...
<form action="../plotPage/temp_line.php" method="get">
